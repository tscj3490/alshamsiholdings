 ...
 *
 */
	$assign_to_config['site_name']  = 'Alshamsiholdings';
	$assign_to_config['cp_url'] = 'http://localhost/alshamsiholdings/admin.php'; // 'http://alshamsiholdings.com/admin.php';
	$assign_to_config['site_url'] = 'http://localhost/alshamsiholdings'; // 'http://alshamsiholdings.com/';

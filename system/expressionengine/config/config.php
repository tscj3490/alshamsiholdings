...
$config['debug'] = "1";
$config['cp_url'] = "http://localhost/alshamsiholdings/system/index.php"; // http://alshamsiholdings.com/system/index.php
$config['doc_url'] = "http://expressionengine.com/user_guide/";
$config['is_system_on'] = "y";
$config['allow_extensions'] = 'y';
$config['site_label'] = 'al shamsi';
...
|
*/
$config['base_url']	= 'http://localhost/alshamsiholdings'; // 'http://127.0.0.1:8000/'; // http://localhost/codeigniter_project/

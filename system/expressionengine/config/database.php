...
*/
// root@localhost: jjV0V4%rBXsX
$db['expressionengine']['hostname'] = "localhost"; // localhost
$db['expressionengine']['username'] = "root"; // ashdbuser
$db['expressionengine']['password'] = ""; // Ash@db#1
$db['expressionengine']['database'] = "ashcom_db"; // ashcom_db
